...
public class PacmanTestAdapterExtended2 extends PacmanTestAdapterExtended1
{
	/**
	 ...
	 * @param points Zugehörige Punktzahl
	 */
	 ...
	 * Die Punktzahlen werden hier nicht ausgegeben, sie bestimmen nur die Sortierung.
	 * Am geringsten Index im Array soll also die höchste Punktzahl liegen.
	 * 
